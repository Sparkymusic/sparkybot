#    Sparky (A Telegram Bot Project)
#    Copyright (C) 2019-2021 Sparky  (https://t.me/sparkypro_bot)
...
from YoneRobot.mongo import mongodb as db
from telethon import *
from telethon.tl import *
from telethon.tl.types import *
from telegraph import Telegraph
import requests
from YoneRobot.Addons.tempmail.tempmail import TempMail
from YoneRobot import tbot

tmail = db.tempmail
from YoneRobot.conf import get_str_key

TEMP_MAIL_KEY = get_str_key("API_HASH", required=False)
...
async def _(event):
    ...
    if not event.sender_id == sender:
        ...
        return
    await tbot.edit_message(chatid, msgid, "Thanks for using Sparky ♥️")
...
async def _(event):
    ...
    telegraph = Telegraph()
    telegraph.create_account(short_name="SparkyRobot")
    if subject == "":
        subject = "No Subject"
