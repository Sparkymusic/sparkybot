...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *sᴘᴀʀᴋʏ*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [ABOUT OWNER](t.me/sparkyvc).
                 \n\nIf you have any question about sparky, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *sᴘᴀʀᴋʏ*
                 \nHere is the [Source Code](t.me/sparkypro_support) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yes I'm alive Sᴘᴀʀᴋʏ 🤍💫")
        except Unauthorized:
            LOGGER.warning(
